...
export default function Login(){
    ...
    const handleLogin = async (data) => {
        ...
        await api
        .post('/usuario/login', {"email": data.email, "senha": data.password})
        .then((response) => {
            dispatch(logar( {   name: response.data.nome,
            ...
            >
                ...
                >
                    <View style={{ alignSelf: 'flex-start', padding: 10, marginLeft: -10}}>
                        <Ionicons name="arrow-back" size={30} color="#000fff" />
                    </View>
                </TouchableNativeFeedback>
                ...
                <AreaInput>
                    <IconArea>
                        <MaterialCommunityIcons name="email-outline" size={20} color={inputAtivo.email ? '#000fff' : "#000fff"} />
                    </IconArea>
                ...
                <AreaInput>
                    <IconArea>
                        <MaterialCommunityIcons name="key-outline" size={20} color={inputAtivo.senha ? '#000fff' : "#AAAAAA"} />
                    </IconArea>
